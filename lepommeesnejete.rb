...
possible_adjectives = [
  [ ["rouge",  "rogue"], ["rouge",  "orange"], ["rouge",  "jaune"] ],
  [ ["orange", "rogue"], ["orange", "orange"], ["orange", "jaune"] ],
  [ ["jaune",  "rogue"], ["jaune",  "orange"], ["jaune",  "jaune"] ],
]
...
system("espeak -v fr '#{word_class} #{classified_nouns} #{adjectives} #{subjects} #{verbs}.'")
